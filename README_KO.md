...
│  │ → 신호 계산  │  │ → Sonnet 4.6 분석  │  │ → Sonnet 4.6    │ │
│  │ (LLM 없음)   │  │                    │  │                 │ │
│  └──────┬───────┘  └─────────┬──────────┘  └────────┬────────┘ │
│         └──────────────────┬─┘────────────────────────┘         │
│                            ↓                                     │
...
| 전략 | 총수익률(%) | 연환산수익률(%) | 연환산변동성(%) | 샤프비율 | 최대낙폭(%) | 카르마비율 | 초과수익률(%) |
|---|---|---|---|---|---|---|---|
| Claude Haiku | 47.52 | 20.37 | 9.70 | 2.100 | -4.69 | 4.345 | +7.76 |
| GPT-4o-mini | 36.41 | 15.60 | 11.00 | 1.419 | -9.91 | 1.574 | +3.00 |
| KOSPI_proxy (벤치마크) | 29.41 | 12.60 | 16.09 | 0.783 | -11.36 | 1.109 | — |
